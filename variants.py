...
_LIVE_VARIANTS = [
    ...
    # [التغيير #6] صياغتا كشف الغموض. كلتاهما تعرضان **أسماء بلا
    # أسعار**: رسالة تحمل سعراً هي رد بالسعر مهما كانت نيّتها، وعرض
    # ثلاثة أسعار في سؤال توضيح يجعل العميلة مسعَّرة بلا Lead - الفراغ
    # نفسه الذي جاء هذا التغيير ليغلقه. `options_list` تبنيه
    # services.service_options_text وهو مرقَّم بلا سعر.
    Variant(
        variant_id="ambiguity_question.v1",
        intent="ambiguity_question",
        template=(
            "عندنا أكثر من خدمة تناسب اللي تسألين عنه 🌸\n"
            "{options_list}\n\n"
            "أي وحدة تقصدين؟ ترسلين الرقم أو اسم الخدمة."
        ),
    ),
    # تُرسَل حين يبقى الجواب غير حاسم: لم يُفهَم، أو طابق أكثر من
    # مرشَّح من جديد. تعيد عرض نفس الخيارات - سؤال بلا قائمة يطلب من
    # العميلة أن تتذكّر.
    Variant(
        variant_id="ambiguity_reprompt.v1",
        intent="ambiguity_reprompt",
        template=(
            "حتى أعطيك السعر الصحيح، أي وحدة من هذي تقصدين؟ 🌸\n"
            "{options_list}\n\n"
            "ترسلين الرقم أو اسم الخدمة."
        ),
    ),
    Variant(
